...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/29 12:29:10 by seemil            #+#    #+#             */
/*   Updated: 2024/09/29 13:24:34 by eyetis           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	delete_unnecessary_quotes(char **data)
{
	...
	new_data = (char *)malloc(sizeof(char) * (ft_strlen(*data)
				- count_unnecessary_quotes(*data) + 1));
	if (!new_data)
		return ;
	i = 0;
	j = 0;
